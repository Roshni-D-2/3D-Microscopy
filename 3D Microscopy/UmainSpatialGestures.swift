//
//  UmainSpatialGestures.swift
//  3D Microscopy
//
//  Created by Future Lab XR1 on 7/9/25.
//
...
//    /
//    / This method enhances the interactivity of a view by enabling it to respond to drag gestures.
//    / It is useful for creating draggable components within your user interface, allowing users to move views around within their parent view or container.
//    /
...
//    /
//    / This method enables a view to be rotated by the user through gesture interactions.
//    / The rotation can be constrained to a specific axis, providing a controlled rotation experience.
//    / It's particularly useful for 3D views where you might want to limit rotation to maintain a certain orientation or for 2D views where you want to add interactive rotation behavior.
//    /
...
//    /
//    / This method enables interactive scaling of a view through pinch gestures, commonly used to zoom in or out.
//    / It's especially useful for images, maps, or any content where users might benefit from examining details more closely or seeing the bigger picture by adjusting the view's scale.
//    /
...
//    /
//    / This method allows a view to respond to both drag and pinch (magnification) gestures simultaneously.
//    / It enables interactive movement and scaling of the view, making it useful for creating more dynamic and engaging UI components where the user can adjust both position and size.
//    /
...
//    /
//    / This method combines drag, magnify, and rotation gestures into a single, unified interaction model.
//    / It allows for complex manipulation of a view, including moving, scaling, and rotating, which can be particularly useful for interactive 3D content or detailed user interfaces.
//    / The rotation can be constrained to a specific axis, providing greater control over the view's orientation.
//    /
